...
moeen=Player(name='Moeen Ali',attr=PlayerAttr(bowling=7, batting=7))
...
hafeez=Player(name='M Hafeez',attr=PlayerAttr(batting=6,bowling=6))
imad=Player(name='I Wasim', attr=PlayerAttr(batting=6, bowling=7))
shadab=Player(name='Shadab Khan',attr=PlayerAttr(bowling=7))
...
gayle=Player(name='C Gayle',attr=PlayerAttr(batting=8, bowling=6))
...
nurse=Player(name='A Nurse',attr=PlayerAttr(bowling=8))
...
duminy=Player(name='J P Duminy',attr=PlayerAttr(batting=6,bowling=7))
...
tahir=Player(name='I Tahir',attr=PlayerAttr(bowling=8))
...
dsilva=Player(name='D de Silva',attr=PlayerAttr(batting=7,bowling=7))
...
shakib=Player(name='Shakib Al Hasan',attr=PlayerAttr(batting=8, bowling=7))
rahim=Player(name='M Rahim',attr=PlayerAttr(batting=8, iskeeper=True))
liton=Player(name='Liton Das',attr=PlayerAttr(batting=7, bowling=7))
mahmudullah=Player(name='Mahmudullah',attr=PlayerAttr(batting=6))
sabbir=Player(name='S Rahman', attr=PlayerAttr(batting=6))
mehidy=Player(name='M Hasan',attr=PlayerAttr(batting=7,bowling=7))
