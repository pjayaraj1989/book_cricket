...
team_ind=Team(team_array=ind_squad,color='blue',
...
team_aus=Team(team_array=aus_squad,color='yellow',
...
team_eng=Team(team_array=eng_squad,color='cyan',
...
team_nz=Team(team_array=nz_squad,color='purple',
...
team_pak=Team(team_array=pak_squad,color='green',
...
team_wi=Team(team_array=wi_squad,color='brown',
...
team_sa=Team(team_array=sa_squad,color='lightgreen',
...
team_sl=Team(team_array=sl_squad,color='lightblue',
...
team_ban=Team(team_array=ban_squad,color='gray',
