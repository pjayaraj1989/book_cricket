...
dhawan=Player(name='Shikhar Dhawan',attr=PlayerAttr(batting=8))
rsharma=Player(name='Rohit Sharma', attr=PlayerAttr(batting=8))
kohli=Player(name='Virat Kohli',attr=PlayerAttr(batting=8))
klrahul=Player(name='K.L. Rahul',attr=PlayerAttr(batting=7))
dkarthik=Player(name='Dinesh Karthik',attr=PlayerAttr(batting=6))
dhoni=Player(name='M.S. Dhoni',attr=PlayerAttr(batting=7,iskeeper=True))
hpandya=Player(name='Hardik Pandya',attr=PlayerAttr(bowling=6,batting=6))
ashwin=Player(name='Ravichandran Ashwin',attr=PlayerAttr(bowling=8,isspinner=True))
bkumar=Player(name='Bhuvneswar Kumar',attr=PlayerAttr(bowling=8, isopeningbowler=True))
shami=Player(name='Mohammad Shami',attr=PlayerAttr(bowling=8))
bumrah=Player(name='Jasprit Bumrah',attr=PlayerAttr(bowling=9))
jadeja=Player(name='Ravindra Jadeja',attr=PlayerAttr(bowling=7,batting=7))

warner=Player(name='David Warner',attr=PlayerAttr(batting=8))
finch=Player(name='Aaron Finch',attr=PlayerAttr(batting=7))
khawaja=Player(name='Usman Khawaja',attr=PlayerAttr(batting=7))
ssmith=Player(name='Steve Smith',attr=PlayerAttr(batting=8))
smarsh=Player(name='Shaun Marsh',attr=PlayerAttr(batting=8))
maxwell=Player(name='Glenn Maxwell',attr=PlayerAttr(batting=7,bowling=6, isspinner=True))
stoinis=Player(name='Marcus Stoinis',attr=PlayerAttr(bowling=6, batting=6))
carey=Player(name='Alex Carey', attr=PlayerAttr(batting=6, iskeeper=True))
cummins=Player(name='Pat Cummins',attr=PlayerAttr(bowling=8, isopeningbowler=True))
starc=Player(name='Mitchell Starc',attr=PlayerAttr(bowling=8, isopeningbowler=True))
bdorff=Player(name='Jason Behrendorff',attr=PlayerAttr(bowling=7))
hazlewood=Player(name='Josh Hazlewood',attr=PlayerAttr(bowling=7))
zampa=Player(name='Adam Zampa',attr=PlayerAttr(bowling=7, isspinner=True))

guptill=Player(name='Martin Guptill',attr=PlayerAttr(batting=8))
munro=Player(name='Colin Munro',attr=PlayerAttr(batting=7))
williamson=Player(name='Kane Williamson',attr=PlayerAttr(batting=8))
rtaylor=Player(name='Ross Taylor',attr=PlayerAttr(batting=8))
latham=Player(name='Tom Latham',attr=PlayerAttr(batting=7,iskeeper=True))
neesham=Player(name='Jimmy Neesham',attr=PlayerAttr(batting=6, bowling=7))
dgrandhome=Player(name='Colin deGrandhomme', attr=PlayerAttr(batting=6, bowling=7))
santner=Player(name='Mitchell Santner',attr=PlayerAttr(bowling=7, isspinner=True))
henry=Player(name='Matt Henry',attr=PlayerAttr(bowling=8))
southee=Player(name='Tim Southee',attr=PlayerAttr(bowling=8, isopeningbowler=True))
boult=Player(name='Trent Boult',attr=PlayerAttr(bowling=8, isopeningbowler=True))

roy=Player(name='Jason Roy',attr=PlayerAttr(batting=8))
bairstow=Player(name='Jonny Bairstow',attr=PlayerAttr(batting=7))
root=Player(name='Joe Root',attr=PlayerAttr(batting=8))
morgan=Player(name='Eoin Morgan',attr=PlayerAttr(batting=8))
stokes=Player(name='Ben Stokes',attr=PlayerAttr(batting=7, bowling=7))
buttler=Player(name='Jos Buttler',attr=PlayerAttr(batting=6, iskeeper=True))
woakes=Player(name='Chris Woakes', attr=PlayerAttr(batting=6, bowling=7,isopeningbowler=True))
plunkett=Player(name='Liam Plunkett',attr=PlayerAttr(bowling=7))
archer=Player(name='Joffra Archer',attr=PlayerAttr(bowling=8))
rashid=Player(name='Adil Rashid',attr=PlayerAttr(bowling=7, isspinner=True))
moeen=Player(name='Moeen Ali',attr=PlayerAttr(bowling=7, batting=7, isspinner=True))
wood=Player(name='Mark Wood',attr=PlayerAttr(bowling=8, isopeningbowler=True))
...
sachin=Player(name='Sachin Tendulkar', attr=PlayerAttr(batting=8, bowling=7, isspinner=True))
...
yuvraj=Player(name='Yuvraj Singh',attr=PlayerAttr(batting=7, bowling=8,isspinner=True))
...
nehra=Player(name='Ashish Nehra',attr=PlayerAttr(bowling=8))
...
symonds=Player(name='Andrew Symonds',attr=PlayerAttr(batting=7, bowling=8,isspinner=True))
...
lee=Player(name='Brett Lee',attr=PlayerAttr(bowling=8))
mcgrath=Player(name='Glenn McGrath',attr=PlayerAttr(bowling=9, isopeningbowler=True))
swaugh=Player(name='Steve Waugh',attr=PlayerAttr(batting=7, bowling=8))
...
flintoff=Player(name='Andrew Flintoff',attr=PlayerAttr(bowling=7,batting=6))
...
jayasuriya=Player(name='Sanath Jayasuriya', attr=PlayerAttr(batting=8, bowling=6, isspinner=True))
adesilva=Player(name='Aravinda deSilva',attr=PlayerAttr(batting=8, bowling=6, isspinner=True))
...
samaraweera=Player(name='Thilan Samaraweera',attr=PlayerAttr(bowling=7,batting=6, isspinner=True))
vaas=Player(name='Chaminda Vaas',attr=PlayerAttr(batting=6,bowling=7, isopeningbowler=True))
...
murali=Player(name='Muttiah Muralitharan',attr=PlayerAttr(bowling=9, isspinner=True))
...
kallis=Player(name='Jaques Kallis',attr=PlayerAttr(batting=8, bowling=7))
...
pollock=Player(name='Shaun Pollock',attr=PlayerAttr(bowling=7,batting=6, isopeningbowler=True))
klusener=Player(name='Lance Klusener',attr=PlayerAttr(batting=6,bowling=7))
hall=Player(name='Andrew Hall',attr=PlayerAttr(bowling=8))
ntini=Player(name='Makhaya Ntini',attr=PlayerAttr(bowling=8, isopeningbowler=True))
